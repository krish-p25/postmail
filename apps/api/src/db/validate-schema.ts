...
const EXPECTED_SCHEMA: Record<string, string[]> = {
  users: ['id', 'email', 'password_hash', 'google_id', 'microsoft_id', 'display_name', 'created_at', 'updated_at'],
  tracked_emails: ['id', 'user_id', 'tracking_token', 'recipient', 'subject', 'status', 'sent_at', 'message_id', 'thread_id', 'conversation_id', 'created_at', 'updated_at'],
