...
const EXPECTED_SCHEMA: Record<string, string[]> = {
  users: ['id', 'email', 'password_hash', 'google_id', 'microsoft_id', 'display_name', 'gmail_access_token', 'gmail_refresh_token', 'gmail_token_expiry', 'outlook_access_token', 'outlook_refresh_token', 'outlook_token_expiry', 'created_at', 'updated_at'],
